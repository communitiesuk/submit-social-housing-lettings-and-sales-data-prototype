...
import appGlobals from '../app/globals.js'
import libGlobals from './nunjucks/globals.js'
...
const nunjucksAppFilters = appFilters(nunjucksAppEnv)
...
const nunjucksAppGlobals = { ...appGlobals(nunjucksAppEnv), ...libGlobals(nunjucksAppEnv) }
