...
const wordInSynonymStartsWithQuery = (synonyms, startsWithQueryWordsRegexp) =>
  anyMatch(synonyms, startsWithQueryWordsRegexp, wordsStartsWithQuery)
